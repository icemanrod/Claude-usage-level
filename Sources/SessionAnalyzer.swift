...
enum Log {
    static func info(_ msg: String) { print("[ClaudeUsageLevel] \(msg)") }
    static func warn(_ msg: String) { print("[ClaudeUsageLevel] ⚠ \(msg)") }
    static func error(_ msg: String) { print("[ClaudeUsageLevel] ✗ \(msg)") }
}
