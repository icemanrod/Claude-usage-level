...
A new "ROI" tab in Claude Usage Level that correlates Claude AI spending with Git productivity. Shows cost per commit, cost per line of code, per-project and per-model efficiency, and 30-day trends.
