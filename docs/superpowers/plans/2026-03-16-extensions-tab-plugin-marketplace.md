...
Run: `xcodegen generate && xcodebuild -scheme ClaudeUsageLevel -configuration Debug build 2>&1 | tail -5`
...
Run: `xcodebuild -scheme ClaudeUsageLevel -configuration Debug build 2>&1 | grep "error:" | head -5`
